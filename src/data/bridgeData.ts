...
export const BRIDGES: Record<string, BridgeSpec> = {
  'beam': {
    id: 'beam',
    name: 'Beam Bridge',
    category: 'Short to Medium Span Structures',
    spanRange: '10 – 80 meters',
    tagline: 'Simply supported or continuous horizontal beam superstructure',
    ...
    commonFailureModes: ['Mid-span flexural cracking under overload', 'Pier foundation scour & settlement', 'Fatigue in steel flange welded joints'],
    ...
    nodes: [
      {
        ...
        sensors: ['Wheatstone Strain Gauge + HX711 (24-bit)', 'MPU6050 (3-Axis IMU)', 'BME280 (Temp/Hum)'],
  ...
  'arch': {
    ...
    spanRange: '50 – 400 meters',
    tagline: 'Compressive Curve Structural Rib Architecture',
    description: 'Valleys, deep gorges, historical urban waterways (50m - 400m). Arch bridges carry loads primarily through axial compression forces along the curved rib.',
    ...
    commonFailureModes: ['Arch crown crushing or micro-buckling under overload', 'Abutment sliding & rotation due to thrust', 'Spandrel column joint shear'],
  ...
  'truss': {
    ...
    spanRange: '40 – 250 meters',
    tagline: 'Triangular Strut Lattice Load Distribution',
    description: 'Heavy rail freight lines, wide river crossings, mountain gorges (40m - 250m). Truss structures distribute heavy loads across connected triangular elements.',
    ...
    commonFailureModes: ['Gusset plate connection distortion', 'Fatigue cracking in tension diagonals under overload', 'Member buckling & rivet corrosion'],
    applications: ['Heavy Cargo Railway Bridges', 'Long River Highway Trusses', 'Industrial Haul Corridors'],
    nodes: [
      {
        id: 'T1',
        code: 'T1',
        name: 'Bottom Chord Center Joint (Node A)',
        roleTag: 'Node A (Bottom Chord)',
        nodeTypeId: 'S-Node',
        mcuModel: 'STM32F429ZI',
      ...
      },
      {
        id: 'T2',
        code: 'T2',
        name: 'Top Chord Diagonal Gusset (Node B)',
        roleTag: 'Node B (Gusset Plate)',
        nodeTypeId: 'V-Node',
        mcuModel: 'STM32F411RE',
  ...
  'cantilever': {
    ...
    commonFailureModes: ['Tension arm member overload at extreme fiber', 'Pin-joint corrosion seizure & fracture', 'Expansion joint binding'],
  ...
  'suspension': {
    ...
    commonFailureModes: ['Wind-induced flutter & vortex shedding buffeting', 'Main cable wire corrosion fatigue', 'Tower top saddle binding'],
  ...
  'cable-stayed': {
    ...
    typicalLifespan: '80 – 120 Years',
    commonFailureModes: ['Stay cable rain-wind vibration fatigue', 'Stay anchorage dampener degradation', 'Pylon bending under unbalanced live load'],
    ...
    nodes: [
      ...
      },
      {
        ...
        roleTag: 'Node C (Deck Pylon Base)',
        nodeTypeId: 'S-Node',
        mcuModel: 'STM32F429ZI',
        sensors: ['Wheatstone Strain Gauges', 'MPU6050 IMU', 'BME280 Sensor'],
